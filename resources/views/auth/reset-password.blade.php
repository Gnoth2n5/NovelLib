<x-guest-layout>
    <div class="min-h-screen flex items-center justify-center">
        <div class="card w-full max-w-md bg-base-100 shadow-xl">
            <div class="card-body">
                <h2 class="card-title text-2xl font-bold mb-6 justify-center">Đặt Lại Mật Khẩu</h2>
                    ...
                    <div class="form-control w-full mt-4">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" class="btn btn-ghost btn-sm absolute right-0 top-0 h-full rounded-l-none" onclick="togglePassword('password_confirmation')">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 hidden" id="eyeSlashIcon2">
